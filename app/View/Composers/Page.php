...
class Page extends Composer
{
    ...
    private function add_ids_and_jumpto_links($tag, $content)
    {
        ...
        foreach ($items as $item) {
            ...
            $replacement   .= sprintf('<div class="group relative"><%1$s id="%2$s">%3$s<a href="#%2$s" class="pl-3 before:absolute before:inset-0 group-hover:opacity-70 opacity-0 transition "><svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-width="1.5" class="w-6 h-6 inline-block" viewBox="0 0 24 24">
