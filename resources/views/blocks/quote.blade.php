<div class="{{ $fields->background_colour ?? 'bg-green' }} relative mb-16 overflow-hidden rounded lg:mb-24">
  ...
  <div class="{{ $fields->reverse ? 'lg:flex-row-reverse' : 'lg:flex-row' }} container flex flex-col lg:items-center">
    <div class="relative flex flex-col items-start justify-start pb-12 pt-16 lg:mx-auto lg:w-1/2 lg:p-8">
      <h2 class="text-balance relative mb-6 mt-6 max-w-lg pr-4 font-serif text-4xl md:text-5xl lg:pr-0"><span
          class="block align-bottom font-[math] text-8xl !leading-[0.1px] text-white md:-ml-[3.5rem] md:pr-0 lg:text-9xl">“</span>{{ $fields->quote }}<span
          class="absolute -bottom-10 left-full -ml-8 align-bottom font-[math] text-8xl !leading-[0.1px] text-white lg:ml-0 lg:text-9xl">”</span>
      </h2>
