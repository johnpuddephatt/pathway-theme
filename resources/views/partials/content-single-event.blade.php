<article
  ...
  <div class="container mb-24">
    <div class="flex flex-col gap-8 lg:flex-row-reverse items-start">
      <div class="max-w-screen-sm lg:w-96 rounded bg-blue bg-opacity-20 p-8 pb-4">
      <h3 class="font-bold text-xl mb-3">Key information</h3>
        <ul class="max-w-lg divide-y divide-blue ">
         @if (carbon_get_post_meta(get_the_ID(), 'start_date'))
            <li class="py-4 flex flex-row gap-2 leading-none"><div class="font-semibold w-24">Time & date:</div> 
            <div>
         {{ date(get_option('time_format') . ' ' . get_option('date_format'), strtotime(carbon_get_post_meta(get_the_ID(), 'start_date'))) }}
          ...
          @if (carbon_get_post_meta(get_the_ID(), 'location'))
            <li class="py-4 flex flex-row gap-2 leading-none"><div class="font-semibold w-24">Location:</div> 
            <div>
  ...
  <li class="flex flex-row gap-2 py-4 leading-none">
