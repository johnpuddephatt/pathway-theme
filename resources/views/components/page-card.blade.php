<div
  ...
  <div class="py-6 md:px-6 md:pb-8 md:pt-4">
    ...
    <a href="{{ get_permalink($page->ID) }}}"
      class="rounded-full bg-blue bg-opacity-70 px-6 py-2 font-semibold !text-white !no-underline transition before:absolute before:inset-0 hover:bg-opacity-100 max-md:h-0 max-md:!p-0 max-md:opacity-0 md:mt-6 md:inline-block">Read
      More</a>
  </div>
