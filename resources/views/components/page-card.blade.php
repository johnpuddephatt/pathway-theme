<div
  ...
  <div class="py-6 md:px-6 md:pb-8 md:pt-4">
    ...
    <a href="{{ get_permalink($page->ID) }}}"
      class="mb:text-base inline-block rounded-full bg-blue bg-opacity-70 px-6 py-2 text-[0px] font-semibold !text-white !no-underline transition before:absolute before:inset-0 hover:bg-opacity-100 max-md:h-0 max-md:!p-0 max-md:opacity-0 md:mt-6">Read
      More</a>
  </div>
