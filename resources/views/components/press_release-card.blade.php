<a href="{{ get_permalink($release->ID) }}"
  ...
  <div class="flex flex-row items-center">
    <div class="px-6">
      <h3 class="!my-0 text-2xl font-bold !leading-tight">{{ $release->post_title }}
      </h3>
      <div class="mt-4 flex flex-row items-center gap-2 font-bold text-blue">
        {{ get_the_date(null, $release->ID) }}
      </div>
    </div>

    <svg
      class="ml-auto w-32 flex-none border-l border-white px-4 py-8 transition group-hover:bg-pink group-hover:bg-opacity-40"
