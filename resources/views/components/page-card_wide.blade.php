<a href="{{ get_permalink($page->ID) }}"
  class="relative flex flex-row items-center rounded bg-beige bg-opacity-70 !no-underline transition hover:bg-opacity-100">
  ...
  <div class="ml-auto flex flex-none flex-row items-center self-stretch border-l border-white px-6 py-2">
