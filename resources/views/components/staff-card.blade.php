<a class="not-prose flex flex-row items-center gap-4 overflow-hidden rounded bg-beige bg-opacity-30 px-6 pb-12 pt-8 !no-underline transition hover:bg-opacity-60 sm:block sm:flex-col xl:text-base"
