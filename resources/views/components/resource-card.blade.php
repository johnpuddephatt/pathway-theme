  <a href="{{ get_permalink($resource->ID) }}"
    ...
    <div class="flex flex-row items-center gap-12 border-l-[2rem] border-yellow">
      <div class="px-6">
        ...
        <h3 class="mb-2 text-2xl font-bold">{{ $resource->post_title }}
        </h3>
      ...
      <svg
        class="ml-auto w-32 flex-none border-l border-white px-4 py-8 transition group-hover:bg-yellow group-hover:bg-opacity-30"
